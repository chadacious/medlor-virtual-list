...
export default class VirtualList extends React.PureComponent<Props, State> {
  ...
  componentWillReceiveProps(nextProps: Props) {
    ...
    // console.warn('scrollPropsHaveChanged', scrollPropsHaveChanged, 'itemPropsHaveChanged', itemPropsHaveChanged);
    ...
    if (nextProps.scrollOffset !== scrollOffset) {
      // console.warn('SCROLL_CHANGE_REQUESTED 1');
      this.setState({
      ...
      // console.warn('SCROLL_CHANGE_REQUESTED 2');
      this.setState({
  ...
  componentDidUpdate(_: Props, prevState: State) {
    ...
    // console.warn('componentDidUpdate props', _, this.props);
    // console.warn('componentDidUpdate state', prevState, this.state);
  ...
  handleScroll = (e: UIEvent)  => {
    ...
    if (offset < 0 || this.state.offset.toFixed(0) === offset.toFixed(0) || e.target !== this.rootNode) {
      return;
    }
  ...
  render() {
    ...
    // console.warn('rendering', this.props);
