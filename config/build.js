...
Promise.all([
  runRollup({entry, output: 'medlor-virtual-list.es.js', format: 'es'}),
  runRollup({entry, output: 'medlor-virtual-list.cjs.js', format: 'cjs'}),
  runRollup({entry, output: 'medlor-virtual-list.js', format: 'umd'}),
  runRollup({entry, output: 'medlor-virtual-list.min.js', format: 'umd', minify: true}),
])
